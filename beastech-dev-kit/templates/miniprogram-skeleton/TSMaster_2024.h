...
typedef struct _TTSApp {
    ...
    native_int FDummy[634]; // >>> mp app end <<<
...
// IP functions
typedef s32 (__stdcall* TIoIPCreate)(const void* AObj, const u16 APortTCP, const u16 APortUDP, const TOnIoIPData AOnTCPDataEvent, const TOnIoIPData AOnUDPDataEvent, native_int* AHandle);
...
typedef s32 (__stdcall* Trpc_tsmaster_is_simulation_running)(const pvoid AObj, const native_int AHandle);
...
typedef struct _TTSCOM {
    ...
    native_int FDummy[661]; // >>> mp com end <<<
    // internal functions
    ...
    s32 rpc_tsmaster_is_simulation_running(const native_int AHandle){
        return internal_rpc_tsmaster_is_simulation_running(FObj, AHandle);
    }
    ...
    s32 rpc_tsmaster_cmd_register_signal_cache(const pvoid AObj, const native_int AHandle, const TLIBApplicationChannelType ABusType, const char* ASgnAddress, ps64 AId){
        return internal_rpc_tsmaster_cmd_register_signal_cache(FObj, AHandle, ABusType, ASgnAddress, AId);
    }
    s32 rpc_tsmaster_cmd_unregister_signal_cache(const pvoid AObj, const native_int AHandle, const s64 AId){
        return internal_rpc_tsmaster_cmd_unregister_signal_cache(FObj, AHandle, AId);
    }
    s32 rpc_tsmaster_cmd_get_signal_cache_value(const pvoid AObj, const native_int AHandle, const s64 AId, pdouble AValue){
...
typedef s32 (__stdcall* TSignalTesterSetItemTimeRangeByIndex)(const s32 AIdx, const double ALow, const double AHigh);
typedef s32 (__stdcall* TSignalTesterSetItemTimeRangeByName)(const char* AName, const double ALow, const double AHigh);
...
typedef struct _TTSTest {
    ...
    TSignalTesterSetItemTimeRangeByIndex signal_tester_set_item_value_range_by_index;
    TSignalTesterSetItemTimeRangeByName signal_tester_set_item_value_range_by_name;
    Tclassic_test_system_login classic_test_system_login;
    Tclassic_test_system_import classic_test_system_import;
    native_int FDummy[943]; // >>> mp test end <<<
